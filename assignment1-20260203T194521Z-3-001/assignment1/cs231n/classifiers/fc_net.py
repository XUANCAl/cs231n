...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores = None
        hid, cache1 = affine_relu_forward(X, W1, b1)
        scores, cache2 = affine_forward(hid, W2, b2)
        ...
        dhid, dW2, db2= affine_backward(dscores, cache2)
        grads["W2"] = dW2 + self.reg * W2
        grads["b2"] = db2 
        
        dx, dW1, db1 = affine_relu_backward(dhid, cache1)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers - 1):
            out, cache_i = affine_relu_forward(out, self.params["W"+str(i+1)], self.params["b"+str(i+1)])
            caches.append(cache_i)

        out, cachen = affine_forward(out, self.params["W"+str(self.num_layers)], self.params["b"+str(self.num_layers)])
